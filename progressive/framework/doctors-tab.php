...
$doctor_id = $doctors->get_doctor_id($_SESSION['doctor_email']);
$timestamp = time();
?>
...
<link href="https://fonts.googleapis.com/css2?family=Assistant&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="css/custom.css?<?php echo $timestamp;?>">
...
<nav class="navbar">
    <ul class="navbar-nav">
      <li class="logo">
        <a href="doctors-tab.php" class="nav-link">
      ...
      <li class="nav-item">
        <a href="doctors-tab.php?page=patients" class="nav-link">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li class="nav-item">
        <a href="doctors-tab.php?page=consultation" class="nav-link">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li class="nav-item">
        <a href="doctors-tab.php?page=schedule" class="nav-link">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li class="nav-item">
        <a href="doctors-tab.php?page=settings" class="nav-link">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<div class="wb_title" id="header">
  Doctor's <?php echo $doctors->get_doctor_fullname($doctor_id) ?> Dashboard
</div>
<?php
      switch($page){
                case 'settings':
                    require_once 'settings-module/doctors-index.php';
                break;
                case 'patients':
